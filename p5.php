...
<form method="post">
	<div class="container " style="box-shadow:5px 5px #beccc5;">
		<center><h1 style="text-decoration:underline;">AAA Bank</h1>
...
<?php 
  if(isset($_POST['create']))
  {
	...
	echo"<table border='1'>
		...
		<tr>
			<td colspan='2'><input type='submit' name='create1' value='Create'><input type='reset' name='clear' value='Clear'></td>
		</tr>
