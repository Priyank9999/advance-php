...
<table border="2">
<tr>
	<th colspan="2">Passport details Form</th>
</tr>
<tr>
...
if(!empty($_FILES["photo"]["name"]))
{
	 ...
	 $filepath="image/" .$_FILES["photo"]["name"];
	move_uploaded_file($_FILES["photo"]["tmp_name"],$filepath);
	$sql="INSERT INTO traveler(pno,fname,mname,lname,dob,nationality,address,gender,img)values($pno,'$fname','$mname','$lname','$dob','$nationality','$address','$gender','$filepath')";
...
if(!empty($_FILES["photo"]["name"]))
{
	...
	$sql="update traveler set pno=$pno,fname='$fname',mname='$mname',lname='$lname',dob='$dob',nationality='$nationality',address='$address',gender='$gender',img='$filepath' where pno=$pno";
...
if(isset($_POST['del']))
{
	...
	$sql="delete FROM traveler where pno=$pno";
